...
4) Log in the Pavlovia tab of this experiment to your Pavlovia account.
5) Sync the Experiment to Pavlovia (will take a few seconds).
6) Go to Pavlovia > Dashboard > Experiments > HLJT_online
7) Set the experiment to Pilot or Run mode (run mode requires credits).
8) Click "Pilot experiment"!
